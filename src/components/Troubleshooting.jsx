...
export default function Troubleshooting() {
  ...
  return (
    <motion.section
      id="troubleshooting"
      className="w-screen min-h-screen flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-red-50 to-orange-100 dark:from-gray-800 dark:to-gray-900 transition-colors snap-start snap-always py-20 pt-24 scroll-mt-16"
    ...
    >
      <div className="max-w-7xl mx-auto">
          ...
          <div className="lg:col-span-2">
            ...
            >
              <div className="flex items-center space-x-4 mb-6">
                <span className="text-3xl sm:text-4xl">{activeItemData?.icon}</span>
                <div>
                ...
                <ol className="space-y-3">
                  {activeItemData?.steps.map((step, idx) => (
                    <li key={idx} className="flex items-start space-x-3">
                      ...
                      <span className="text-gray-700 dark:text-gray-300 text-sm sm:text-base">{step}</span>
                    </li>
                  ))}
                </ol>
              </div>
        ...
        {/* Debug Section */}
        <motion.div
          className="mt-12 sm:mt-16 bg-white dark:bg-gray-800 rounded-xl p-4 sm:p-6 lg:p-8 shadow-lg"
        ...
        >
          ...
          <div className="mt-4 sm:mt-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4 text-center">
            <div className="bg-blue-50 dark:bg-blue-900/20 p-3 sm:p-4 rounded-lg">
              ...
              <div className="text-xs sm:text-sm font-semibold text-blue-800 dark:text-blue-200">
                YouTube Data API
              </div>
            ...
            <div className="bg-purple-50 dark:bg-purple-900/20 p-3 sm:p-4 rounded-lg">
              <div className="text-xl sm:text-2xl mb-2">🔗</div>
              <div className="text-xs sm:text-sm font-semibold text-purple-800 dark:text-purple-200">
                GitHub Repository
              </div>
